...
<head>
    ...
    <link rel="shortcut icon" href="favicon.ico"> <link href="resources/css/bootstrap.min14ed.css?v=3.3.6" rel="stylesheet">
    ...
    <div class="middle-box text-center loginscreen  animated fadeInDown">
        <div>
            <div>
                ...
                <h1 class="logo-name">SMart</h1>

            </div>
            <h3>SmartParking</h3>

            <form class="m-t" role="form" method="post" action="/user/login.do">
