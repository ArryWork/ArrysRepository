...
<div class="container-fluid ">
    <div class="row clearfix midspace">
        ...
        <div class="userInfo">
            ...
            <ul class="list-unstyled m-t-md">
                ...
                <li>
                    <label>开始停车时间:</label><span id="parkTime"><fmt:formatDate type="date" value="${bookInfo.parktime}"  pattern="yyyy年MM月dd日 HH:mm:ss"/></span>
                </li>
                <li>
                    <h1 style="margin-left: 20px">已停${bookInfo.hasParkedTime}</h1>
                </li>
            </ul>
        </div>
    </div>
    <div class="row clearfix bottomspace">
        <div class="midfuck"></div>
        <button class="btn btn-primary dim btn-lg" style="width: 180px" id="parkEndBtn" data-toggle="modal" data-target="#confirmEndModal" type="button">停车结束</button>
    </div>
    <div  class="modal inmodal" id="confirmEndModal"   keyboard="true">
        <div class="modal-dialog modal-md">
            <div class="modal-content animated bounceInRight">
                ...
                <div class="modal-footer">
                    <form method="POST" action="endPark.do">
                        <button type="button" class="btn btn-white" data-dismiss="modal">关闭</button>
                        <button type="submit" class="btn btn-primary" id="confirmEnd">确定</button>
                        <input type="hidden" name="bookInfoId" value="${bookInfo.fid}"/>
                    </form>
                </div>
            </div>
        </div>
