...
<div class="container-fluid ">
    <div class="row clearfix topNav">
        ...
        <div class="orderTitle">未支付账单</div>
    </div>
    <div class="row" id="OrderDiv">
        <div class="row orderInfo">
            <div class="orderTop">福建农林大学  第一停车场</div>
            <div class="orderMid">
                    <span class="startTime">2016-07-23 10:10:01</span>
                至
                    <span class="endTime">2016-07-24 01:20:32</span>
            </div>
...
<script src="${basePath}/resources/js/rePayOrder.js"></script>
